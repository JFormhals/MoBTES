...
model DoubleUsegment "Double-U borehole heat exchanger"
	...
	Utilities.HeatTransfer.ThermalResistor_amplified R_fluidToGrout_flow(
	...
	parameter Real x_grout_center(
		min=0,
		max=1)=MoBTES.Components.Storage.BoreholeStorage.Functions.xGroutCenter_2U(BHEdata,groutData) "auxillary variable for grout centre of mass";

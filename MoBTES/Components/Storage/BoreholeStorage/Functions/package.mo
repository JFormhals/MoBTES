...
<li><strong style=\"color:red\">Real[:]</strong> heightVector	<i style=\"color:brown\">vertical model discretization [m]</i></li>
	...
	function ElementGroundData "determine type of ground for each element"
		...
		replaceable input MoBTES.Parameters.Locations.TUDa location constrainedby MoBTES.Parameters.Locations.LocationPartial "stratigraphy at location";
...
<p>
Returns the number of vertical elements of the global model's mesh. This is used as input for the actual meshing function and is a workaround for function handling of arrays with variable size. The function body is equal to the body of the function <a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.ElementHeights\">ElementHeights</a>.
<h4>
<strong>Input arguments</strong>
</h4>
<ul>
...
<li><strong style=\"color:red\">Real[:]</strong> supermesh	<i style=\"color:brown\">Array with vertical model sections with constant parameters.</i></li>
	...
	function xGroutCenter_2U "determine grout center for double-U BHE"
		extends Modelica.Icons.Function;
		input MoBTES.Parameters.BoreholeHeatExchangers.DoubleU_DN32 bheData=MoBTES.Parameters.BoreholeHeatExchangers.DoubleU_DN32() "number of rings containing BHEs";
		input MoBTES.Parameters.Grouts.Grout10 groutData=MoBTES.Parameters.Grouts.Grout10();
...
<li><strong style=\"color:red\">Real</strong> xGroutCenter	<i style=\"color:brown\">Relative position of the grout's center of mass (0 < x < 1). </i></li>
	...
	function xGroutCenter_1U "determine grout center for single-U BHE"
		extends Modelica.Icons.Function;
		input MoBTES.Parameters.BoreholeHeatExchangers.SingleU_DN32 bheData=MoBTES.Parameters.BoreholeHeatExchangers.SingleU_DN32() "number of rings containing BHEs";
		input MoBTES.Parameters.Grouts.Grout10 groutData=MoBTES.Parameters.Grouts.Grout10();
		output Real xGroutCenter "Relative position of grout mass center.";
		protected
...
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.BHE_HeadElementIndex\">BHE_HeadElementIndex</a></td>
  <td>Returns the depth-index of the volume element containing the BHE head</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.BHE_BottomElementIndex\">BHE_BottomElementIndex</a></td>
  <td>Returns the depth-index of the volume element containing the BHE bottom</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.ElementHeights\">ElementHeights</a></td>
  <td>Returns an array with the vertical discretization of the model</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.ElementGroundData\">ElementGroundData</a></td>
  <td>Returns a matrix that contains the thermal properties of each global model element</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.MeshR\">MeshR</a></td>
  <td>Returns an array with the radial mesh</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.nElementsZ\">nElementsZ</a></td>
  <td>Returns the vertical number of elements in the model (necessary input for the meshing function)</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.NumberOfBHERings\">NumberOfBHERings</a></td>
  <td>Returns the number of model rings that contain BHEs</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.NumberOfBHEsPerRing\">NumberOfBHEsPerRing</a></td>
  <td>Returns an array with the number of BHEs inside each model ring that contains BHEs</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.SupermeshZ\">SupermeshZ</a></td>
...
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.xGroutCenter_2U\">xGroutCenter_2U</a></td>
  <td>Returns the relative positioning of the grout's center of mass inside the borehole for double-U BHEs</td>
</tr>
<tr>
  <td><a href=\"modelica://MoBTES.Components.Storage.BoreholeStorage.Functions.xGroutCenter_1U\">xGroutCenter_1U</a></td>
